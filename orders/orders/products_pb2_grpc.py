...
class productsStub(object):
  ...
  def __init__(self, channel):
    ...
    self.update_products_inventory = channel.unary_unary(
        '/products.products/update_products_inventory',
        request_serializer=products__pb2.UpdateInventoryRequest.SerializeToString,
        response_deserializer=products__pb2.UpdateInventoryResponse.FromString,
        )
...
def add_productsServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'update_products_inventory': grpc.unary_unary_rpc_method_handler(
          servicer.update_products_inventory,
          request_deserializer=products__pb2.UpdateInventoryRequest.FromString,
          response_serializer=products__pb2.UpdateInventoryResponse.SerializeToString,
      ),
  }
